(use-package! helm
  ...
  :init
  (map! "M-x"                          'helm-M-x)
  (map! "M-y"                          'helm-show-kill-ring)
  (map! "C-x C-f"                      'helm-find-files)
  (map! "C-c <SPC>"                    'helm-all-mark-rings)
  (map! "C-x r b"                      'helm-filtered-bookmarks)
  (map! "C-h r"                        'helm-info-emacs)
  (map! "C-h i"                        'helm-info-at-point)
  (map! "C-x C-d"                      'helm-browse-project)
  (map! "M-3"                          'helm-resume)
  (map! "C-h C-f"                      'helm-apropos)
  (map! "C-h a"                        'helm-apropos)
  (map! "<f2>"                         'helm-execute-kmacro)
  (map! "C-c i"                        'helm-imenu-in-all-buffers)
  (map! "C-s"                          'helm-occur)
